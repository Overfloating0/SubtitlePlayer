...
一个纯前端网页视频播放器，专注于字幕浏览与编辑。支持 SRT/VTT/TXT 字幕上传、实时 CC 显示、文稿面板、编辑导出、多主题切换、键盘快捷键，所有数据可持久化。

**无需安装，无需服务器，下载即用。** 用 Chrome/Edge 打开 `字幕播放器.html` 就能开始。

---

## 快速开始

1. 用 Chrome / Edge 打开 `字幕播放器.html`
2. 点击 **🎬 打开视频** 加载视频文件
3. 点击 **📄 上传字幕** 加载 SRT、VTT 或 TXT 文件
4. 播放视频，右侧实时跟随当前字幕
